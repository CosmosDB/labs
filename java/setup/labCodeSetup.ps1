...
Copy-Item -Path .\templates\src -Recurse -Destination $targetPath -Container -Force
Copy-Item -Path .\templates\pom.xml -Recurse -Destination $targetPath -Container -Force
